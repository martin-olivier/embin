...
def run():
    ...
    test("embin " + test_bin + " --lang=cpp --name=asset --format=hex -o asset.hpp")
    test("embin " + test_bin + " --lang=cpp --name=asset --format=octal -o asset.hpp")
    test("embin " + test_bin + " --lang=cpp --name=asset --format=char -o asset.hpp")
